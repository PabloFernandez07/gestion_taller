...
public class TxRepara {
    ...
    static String sql_4 = "SELECT * FROM servicio_repara WHERE fkServicio = ? AND fkRepara = ?;";
    ...
    private static int NuevoServicioRepara(Connection conn, int pkServicio, int maxPkRepara, int pkMecanico) throws SQLException {
        ...
        if (!rs.next()){
            ...
            JOptionPane.showMessageDialog(null,"Ya existe un servicio_Repara con ese servicio.", "Error", JOptionPane.ERROR_MESSAGE);
        }
